...
export default function ViewItemModal({
  ...
  const { data: currentLocation } = useLocationByItem(data?.id || null);
  ...
  const buildingName =
    buildings.find((b) => b.id === currentLocation?.building_id)?.name ||
    "Noma’lum";
  ...
  return (
    ...
    >
      <Row gutter={32} className="mb-6 mt-4">
        <Col span={12}>
          <div className="mb-4">
            <div className="text-[12px] text-[#666] mb-1 dark:text-gray-300">
              KK Raqam
            </div>
            <div className="text-[14px] font-semibold text-[#2563EC]">
              KK-{data.id}
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            {data.category && (
              <div className="text-[14px] font-semibold dark:text-gray-400">
                {data.category?.name}
              </div>
            )}
          </div>
          ...
          <div className="mb-4">
            ...
            <Tag
              color={statusColor[data.status] || "blue"}
        ...
        <Col span={12}>
          <div className="mb-4">
            <div className="text-[12px] text-[#666] mb-1 mt-2 dark:text-gray-300">
              INV Raqam
            </div>
      ...
      <div className="mb-6">
        <div className="text-[12px] text-[#666] mb-2 font-semibold dark:text-gray-300">
          Joylashuv
        </div>
        <div className="text-[13px text-[#000] dark:text-gray-400">
          {locationString}
        </div>
      </div>
      ...
      <div className="flex gap-3 justify-start pt-4">
        <Button
          type="primary"
          onClick={onEdit}
          style={{ padding: "6px 24px", backgroundColor: "#1890ff" }}
        >
